    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isLogin) {
                ...
                alert("Account created! A verification email has been sent to your inbox. Please verify your email before fully using the system.");
            }

            // Save user role locally for quick access if needed
