                ...
                <div className="mt-6 border-t border-gray-100 pt-6">
                    ...
                    {(isGeneratingExam || isGeneratingResources) && (
                        <div className="text-center py-16 text-blue-500/80">
                            ...
                            <p className="font-medium text-gray-600 tracking-wide text-sm">EduGenie is thinking and crafting the perfect <span className="text-blue-600 font-bold">{isGeneratingExam ? 'exam' : 'study list'}</span>...</p>
                        </div>
                    )}
